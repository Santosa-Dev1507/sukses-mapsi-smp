...
"pertanyaan": "Dalam hüding Fiqiih Liln srngenal -1 imalish, ıilauis suwuhsh It1sLlus idalals pervnris Inu ıln nnnalan jxnna isahil It'ulslnilıt ynu inajils kilis 1Lıil Iun Innmintli jsnxlnttniıysı. tkuikus indalırls Lr-.| uuxlisal Ieısrluı lıscuntli ...",
...
// Logika pemilihan tahun soal secara dinamis
let quizData = tahun === '2026' ? quizData2026 : (tahun === '2025' ? quizData2025 : quizData2024);
if (typeof window !== 'undefined') {
    const urlParams = new URLSearchParams(window.location.search);
    const tahun = urlParams.get('tahun') || '2024';
    quizData = tahun === '2026' ? quizData2026 : (tahun === '2025' ? quizData2025 : quizData2024);
}
