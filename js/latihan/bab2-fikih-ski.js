// ═══════════════════════════════════════════════════════════
// BAB 2 Fikih-SKI (SELASA) — SALAT JUMAT, PERJALANAN MUSAFIR & PERADABAN ABBASIYAH
// 24 Soal Premium Hari Selasa (Kelompok Fikih-SKI) — Teks Arab Berharakat Presisi
// Format: 12 PG Standar + 6 PGK (2 Jawaban Benar) + 6 Benar/Salah (BS)
// ═══════════════════════════════════════════════════════════
var latihanData = [

    // ── BAGIAN 1: ASPEK FIKIH & SKI BAB 2 (SOAL 1 s.d. 16) ──
...
يٰٓاَيُّهَا الَّذِيْنَ اٰمَنُوْٓا اِذَا نُوْدِيَ لِلصَّلٰوةِ مِنْ يَّوْمِ الْجُمُعَةِ فَاسْعَوْا اِلٰى ذِكْرِ اللّٰهِ وَذَرُوا الْبَيْعَ",
        ...
        kunci: 1,
        penjelasan: "Hukum melaksanakan salat Jumat bagi setiap laki-laki muslim yang memenuhi syarat wajib adalah Fardhu 'Ain (kewajiban individu) yang tidak boleh ditinggalkan tanpa uzur syar'i."
    },
    ...
    // Soal 2 (PG Standar)
    {
        ...
        opsi: [
            ...
            "Mengucapkan salam sebanyak tiga kali sebelum naik ke atas mimbar",
            "Membaca doa keberkahan untuk seluruh raja di dunia"
        ],
        kunci: 0,
        penjelasan: "Rukun khotbah Jumat meliputi: memuji Allah (Hamdalah), membaca salawat atas Nabi saw., berwasiat takwa, membaca sekurang-kurangnya satu ayat Al-Qur'an pada salah satu khotbah, dan mendoakan kaum muslimin pada khotbah kedua."
    },
    ...
    // Soal 3 (PG Standar)
    {
        ...
        kunci: 0,
        penjelasan: "Menghimpun dua salat fardhu (Dzuhur & Ashar) yang masing-masing meringkas rakaatnya menjadi 2 rakaat dan dikerjakan pada waktu salat pertama (Dzuhur) disebut Salat Jama' Taqdim Qashar."
    },
    ...
    // Soal 4 (PG Standar)
    {
        ...
        opsi: [
            ...
            "Sekitar 40 km",
            "Sekitar 81–89 km (2 marhalah / 16 farsakh)",
            "Sekitar 200 km"
        ],
        kunci: 2,
        penjelasan: "Jarak minimal perjalanan yang membolehkan rukhshah qashar salat menurut jumhur ulama Syafi'iyah adalah 2 marhalah atau setara dengan 81 hingga 89 kilometer."
    },
    ...
    // Soal 5 (PG Standar)
    {
        ...
        kunci: 1,
        penjelasan: "Khalifah pertama sekaligus pendiri Daulah Abbasiyah adalah Abul Abbas as-Saffah (750-754 M)."
    },
    ...
    // Soal 6 (PG Standar)
    {
        ...
        kunci: 1,
        penjelasan: "Kota Baghdad didirikan oleh Khalifah kedua Daulah Abbasiyah, Abu Ja'far al-Mansur, pada tahun 762 M sebagai ibu kota baru daulah."
    },
    ...
    // Soal 7 (PG Standar)
    {
        ...
        kunci: 1,
        penjelasan: "Bayt al-Hikmah (House of Wisdom) merupakan perpustakaan megah dan pusat penerjemahan naskah sains Yunani, Persia, dan India ke dalam bahasa Arab pada masa keemasan Abbasiyah."
    },
    ...
    // Soal 8 (PG Standar)
    {
        ...
        kunci: 1,
        penjelasan: "Al-Khawarizmi (Muhammad bin Musa al-Khawarizmi) adalah ilmuwan matematika dan astronomi muslim pencetus aljabar dan pengenalan angka nol."
    },
    ...
    // Soal 9 (PGK — 2 Jawaban Benar)
    {
        ...
        opsi: [
            ...
            "Musafir yang sedang melakukan perjalanan jauh yang memenuhi syarat safar.",
            "Pedagang kaya yang sedang sibuk melayani pembeli di pasar."
        ],
        kunci: [0, 2],
        penjelasan: "Golongan yang tidak diwajibkan salat Jumat meliputi: wanita, anak-anak, hamba sahaya, orang sakit parah, dan musafir yang sedang dalam perjalanan."
    },
    ...
    // Soal 10 (PGK — 2 Jawaban Benar)
    {
        ...
        opsi: [
            ...
            "Salat Subuh dengan salat Dzuhur."
        ],
        kunci: [0, 2],
        penjelasan: "Pasangan salat fardhu yang sah dijamak hanya dua: (1) Dzuhur dengan Ashar, dan (2) Maghrib dengan Isya. Salat Subuh tidak dapat dijamak dengan salat apa pun."
    },
    ...
    // Soal 11 (PGK — 2 Jawaban Benar)
    {
        ...
        opsi: [
            ...
            "Jauhar al-Siqilli, panglima militer pembangun kota Kairo.",
            "Osman I, pendiri Daulah Turki Usmani di Anatolia."
        ],
        kunci: [0, 1],
        penjelasan: "Ibnu Sina (*The Canon of Medicine*) dan Ar-Razi (*Al-Hawi*) adalah dua pakar kedokteran legendaris pada era Daulah Abbasiyah."
    },
    ...
    // Soal 12 (PGK — 2 Jawaban Benar)
    {
        ...
        opsi: [
            ...
            "Pelarangan pembelajaran ilmu sains asing di luar Al-Qur'an dan Hadis.",
            "Penutupan perpustakaan dan pembatasan kertas buku dari Cina."
        ],
        kunci: [0, 1],
        penjelasan: "Pendorong kemajuan Abbasiyah adalah dukungan tinggi sultan terhadap riset dan penerjemahan, serta sikap terbuka dalam mengasimilasi kebudayaan sains Persia, Yunani, dan India."
    },
...
Apakah pernyataan di atas BENAR atau SALAH?",
        ...
        kunci: 0,
        penjelasan: "BENAR. Salat Jumat menggantikan kewajiban salat Dzuhur bagi laki-laki muslim yang melaksanakannya."
    },
...
Apakah pernyataan di atas BENAR atau SALAH?",
        ...
        kunci: 1,
        penjelasan: "SALAH. Salat yang boleh di-qashar hanya salat 4 rakaat (Dzuhur, Ashar, dan Isya) menjadi 2 rakaat. Salat Subuh (2 rakaat) dan Maghrib (3 rakaat) tidak boleh di-qashar."
    },
...
Apakah pernyataan di atas BENAR atau SALAH?",
        ...
        kunci: 0,
        penjelasan: "BENAR. Pengepungan Baghdad tahun 1258 M oleh Hulagu Khan menghancurkan kota Baghdad dan mengakhiri Daulah Abbasiyah periode Baghdad."
    },
...
Apakah pernyataan di atas BENAR atau SALAH?",
        ...
        kunci: 0,
        penjelasan: "BENAR. Jabir bin Hayyan adalah perintis ilmu kimia eksperimental pada masa Daulah Abbasiyah."
    },
...
يٰٓاَيُّهَا الَّذِيْنَ اٰمَنُوا اتَّقُوا اللّٰهَ حَقَّ تُقٰتِهٖ وَلَا تَمُوْتُنَّ اِلَّا وَاَنْتُمْ مُّسْلِمُوْنَ",
        ...
        opsi: [
            ...
            "Mendirikan tempat ibadah di setiap sudut desa",
            "Mempelajari ilmu tajwid tanpa mengamalkan isinya"
        ],
        kunci: 0,
        penjelasan: "Q.S. Ali 'Imran/3: 102 memerintahkan orang-orang beriman untuk bertakwa dengan sebenar-benar takwa (haqqa tuqātih) dan konsisten menjaga iman hingga wafat dalam keadaan muslim."
    },
    ...
    // Soal 18 (PG Standar)
    {
        ...
        kunci: 1,
        penjelasan: "Qalqalah Kubra terjadi jika huruf qalqalah (ب, ج, د, ط, ق) mati/sukun karena di-waqaf-kan di akhir bacaan, seperti pada kata اَحَدٌۚ (dibaca aḥad)."
    },
    ...
    // Soal 19 (PGK — 2 Jawaban Benar)
    {
        ...
        opsi: [
            ...
            "عَمَّ يَتَسَاۤءَلُوْنَ (Mim bertasydid).",
            "بِسْمِ اللّٰهِ (Lam Jalalah)."
        ],
        kunci: [0, 2],
        penjelasan: "Ghunnah wajib dibaca mendengung 2 harakat saat ada huruf Nun bertasydid (نَّ) seperti pada اِنَّ atau Mim bertasydid (مَّ) seperti pada عَمَّ."
    },
...
Apakah pernyataan di atas BENAR atau SALAH?",
        ...
        kunci: 0,
        penjelasan: "BENAR. Q.S. Luqman/31: 33 memperingatkan agar manusia tidak tertipu oleh perhiasan duniawi dan godaan setan."
    },

    // ── BAGIAN 3: ASPEK AQIDAH-AKHLAK BAB 2 (SOAL 21 s.d. 24) ──
    ...
    // Soal 21 (PG Standar)
    {
        ...
        kunci: 1,
        penjelasan: "Malaikat Jibril bertugas menyampaikan wahyu Allah Swt. kepada para nabi dan rasul."
    },
    ...
    // Soal 22 (PG Standar)
    {
        ...
        kunci: 1,
        penjelasan: "Syukur (الشُّكْرُ) adalah ungkapan terima kasih dan pengakuan tulus atas segala nikmat pemberian Allah Swt. yang diwujudkan melalui lisan, hati, dan perbuatan."
    },
    ...
    // Soal 23 (PGK — 2 Jawaban Benar)
    {
        ...
        opsi: [
            ...
            "Kitab Al-Qur'an diturunkan kepada Nabi Ibrahim a.s.."
        ],
        kunci: [0, 2],
        penjelasan: "Pasangan yang benar: Taurat -> Nabi Musa a.s., Zabur -> Nabi Daud a.s., Injil -> Nabi Isa a.s., dan Al-Qur'an -> Nabi Muhammad saw.."
    },
